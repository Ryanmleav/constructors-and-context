...
User.prototype.addSavedPost = function (id, title, rating) {
  ...
  let post1 = { id, title, rating }
  this.savedPosts.push(post1)
}
////////// PROBLEM 6 //////////
...
// let newUser = new User('mike', 30, 'mike@gmail.com', [{id : 1, title : 'uh', rating : 3}])
...
User.prototype.changePostRating = function (id, rating2) {
  let changedIndex = this.savedPosts.findIndex((element) => {
    return element.id === id
  })
  this.savedPosts[changedIndex].rating = rating2
}